...
pagedown::chrome_print("slides.html", output = "slides/slides.pdf")
pages <- pdftools::pdf_info("slides/slides.pdf")$pages
filenames = sprintf("slides/slides_%02d.png", 1:pages)
pdftools::pdf_convert("slides/slides.pdf", filenames = filenames)
